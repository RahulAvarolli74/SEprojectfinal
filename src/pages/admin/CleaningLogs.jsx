        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-slate-800/50 border-b border-slate-700/50">
              <tr>
                <th className="text-left px-6 py-4 text-sm font-semibold text-slate-300">Date & Time</th>
                ...
                <th className="text-left px-6 py-4 text-sm font-semibold text-slate-300">Tasks</th>
                <th className="text-left px-6 py-4 text-sm font-semibold text-slate-300">Feedback</th>
                <th className="text-left px-6 py-4 text-sm font-semibold text-slate-300">Image</th>
              </tr>
            </thead>
