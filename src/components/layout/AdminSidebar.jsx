    ...
    <>
      ...
      `}>
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          {/* User info */}
          <div className="p-4 mx-4 mt-6 bg-[#800000]/5 border border-[#800000]/10 rounded-xl shrink-0">
            <div className="flex items-center gap-3">
          ...
          <div className="p-4 border-t border-slate-100 bg-white shrink-0">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-slate-500 hover:bg-red-50 hover:text-red-600 transition-all duration-300 font-medium group"
            >
